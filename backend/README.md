...
## Project Structure
    ...
    ├── testapiautoteammemb_54685  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_54685`
...
2. Clone this repo and `cd testapiautoteammemb_54685`
